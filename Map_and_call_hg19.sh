...
bwa mem   -t 16  /labshares/fanlab/anqin/REF/Hg19/Homo_sapiens/UCSC/hg19/Sequence/BWAIndex/genome.fa  ${1} ${2} > ${1}_hg19_bwa_align.sam
...
/home/qan/jdk1.8.0_77/bin/java -Djava.io.tmpdir=`pwd`/tmp -jar /home/qan/picard-tools-2.1.1_03282016/picard.jar  AddOrReplaceReadGroups \
	I=${1}_hg19_bwa_align.sam \
	O=${1}_hg19_bwa_align_gpi.bam \
	RGID=${3} \
	RGLB=lib1 \
	RGPL=illumina \
	RGPU=unit1 \
...
#bug fixed
samtools sort -@ 10  ${1}_hg19_bwa_align_gpi.bam  ${1}_hg19_bwa_align_sorted_gpied
...
/home/qan/jdk1.8.0_77/bin/java -Djava.io.tmpdir=`pwd`/tmp -jar /home/qan/picard-tools-2.1.1_03282016/picard.jar  MarkDuplicates \
	I=${1}_hg19_bwa_align_sorted_gpied.bam \
	O=${1}_hg19_bwa_align_sorted_gpied_dedup.bam \
...
samtools index ${1}_hg19_bwa_align_sorted_gpied_dedup.bam

#Create realignment targets
/home/qan/jdk1.8.0_77/bin/java -Xms6G -Xmx8G  -jar $GATK -T RealignerTargetCreator -nct 1 -nt 24 -R /labshares/fanlab/anqin/REF/Hg19/Homo_sapiens/UCSC/hg19/Sequence/WholeGenomeFasta/genome.fa  \
	-I ${1}_hg19_bwa_align_sorted_gpied_dedup.bam  \
...
/home/qan/jdk1.8.0_77/bin/java  -jar $GATK -T IndelRealigner \
	...
	-o ${1}_hg19_bwa_align_sorted_gpied_dedup_realign.bam
